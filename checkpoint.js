...
function index() {
  ...
  index.findIndex((objeto, indice, numeros) => {
    return objeto.numeros === numeros;
  });
}
...
function crearClaseEmpleado() {
  ...
  class Empleado {
    ...
    getTareas() {
      ...
      let rObj = {};
      let tarea = this.tareas.map(function (obj) {
        rObj = [obj.tarea];
      });
      return rObj;
    }
